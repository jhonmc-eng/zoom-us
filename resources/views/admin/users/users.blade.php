                        ...
                        <div class="modal-body">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputCharge" class="col-sm-4 col-form-label">Cargo:</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="inputCharge" class="form-control" id="inputDate" placeholder="Cargo del Usuario" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputPermission" class="col-sm-4 col-form-label">Permisos:</label>
                                        <div class="col-sm-8">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputUpdateCharge" class="col-sm-4 col-form-label">Cargo:</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="inputUpdateCharge" class="form-control" id="inputDate" placeholder="Cargo del Usuario" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputUpdatePermission" class="col-sm-4 col-form-label">Permisos:</label>
                                            <div class="col-sm-8">
                                                <select name="inputUpdatePermission" class="form-control">
                                                    <option value="1">CAS</option>
                                                    <option value="2">Practicas</option>
                                                    <option value="3">Ambos</option>
                                                </select>
