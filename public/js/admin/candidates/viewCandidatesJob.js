$(document).ready(function() {
    ...
    var table = $('#datable').DataTable({
        ...
        autoWidth: false,
        ajax: {
            url: `/admin/jobs/list-candidates?job_id=${params.get('job_id')}`,
            dataSrc: 'data',
            type: "GET"
        },
        ...
        columns: [
            ...
            },
            {
                data: "token",
                render: function(data) {
                    return `<a target=_blank href="/admin/jobs/view-candidates/candidate?postulation_id=${data}" type="button" class="btn btn-primary"><i class="far fa-eye"></i></a>`
                }
            }
        ],
        lengthChange: false,
